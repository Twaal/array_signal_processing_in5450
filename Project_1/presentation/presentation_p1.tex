...
\begin{columns}[T]
\column{0.48\textwidth}
\includegraphics[width=\linewidth,height=0.34\textheight,keepaspectratio]{image-24.png}\\[-2pt]
{\scriptsize 2D field: beam confined near aperture, spreading at larger $z$.}

\smallskip
\includegraphics[width=\linewidth,height=0.34\textheight,keepaspectratio]{image-23.png}\\[-2pt]
...
\vspace{-0.3em}
\scriptsize
\textbf{Result:} BW increases proportionally to steering angle magnitude.
\end{frame}
